...
* If you encounter the above error while upgrading from Rails 4.x to 5.1.x, then the problem might be due to the missing `yarn` binstub. Therefore, run the following commands: 
