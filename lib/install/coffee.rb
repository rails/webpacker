...
say "Copying coffee rule to config/webpack/rules"
copy_file "#{__dir__}/rules/coffee.js", Rails.root.join("config/webpack/rules/coffee.js").to_s

say "Adding coffee rule to config/webpack/environment.js"
insert_into_file Rails.root.join("config/webpack/environment.js").to_s,
  "const coffee =  require('./rules/coffee')\n",
  after: /require\(('|")@rails\/webpacker\1\);?\n/

insert_into_file Rails.root.join("config/webpack/environment.js").to_s,
  "environment.rules.prepend('coffee', coffee)\n",
