...
copy_file "#{__dir__}/examples/vue3/hello_vue.js",
  "#{Webpacker.config.source_entry_path}/hello_vue.js"

say "Copying Vue app file to #{Webpacker.config.source_entry_path}"
copy_file "#{__dir__}/examples/vue3/app.vue",
  "#{Webpacker.config.source_path}/app.vue"

Dir.chdir(Rails.root) do
  say "Installing all Vue 3 dependencies"
  run "yarn add vue@next vue-loader@next @vue/compiler-sfc"
end
...
say "Webpacker now supports Vue.js 3 🎉", :green
