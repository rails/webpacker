...
copy_file "#{File.dirname(File.realpath(__FILE__))}/examples/angular/hello_angular.js", "#{Webpacker.config.source_entry_path}/hello_angular.js"

say "Copying hello_angular app to #{Webpacker.config.source_path}"
directory "#{File.dirname(File.realpath(__FILE__))}/examples/angular/hello_angular", "#{Webpacker.config.source_path}/hello_angular"
