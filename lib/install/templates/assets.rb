...
begin
  package_json = Webpacker::PackageJson.config
  package_json[:scripts][:postinstall] = "npm rebuild node-sass"
  package_json[:webpacker][:assets] = true
rescue NoMethodError
  puts "Error: Webpacker core config and scripts key not found in package.json." \
...
copy_file "#{File.expand_path("..", __dir__)}/config/assets.js",
          "config/webpack/assets.js"
