...
copy_file "#{File.dirname(File.realpath(__FILE__))}/loaders/erb.js", Rails.root.join("config/webpack/loaders/erb.js").to_s
...
copy_file "#{File.dirname(File.realpath(__FILE__))}/examples/erb/hello_erb.js.erb",
